...
function openDiscord() {
  window.open('https://discord.com/oauth2/authorize?client_id=1333391301407932426&permissions=0&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%2Fauth%2Fdiscord&integration_type=0&scope=identify+guilds+email+connections+bot+voice+openid+rpc', '_blank');
}
</script>
